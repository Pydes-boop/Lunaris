	...
	void OnGUI()
	{
		if (!doorOpen)
		{
			...
			if (keypadScreen)
			{
				...
				if (GUI.Button(new Rect(110, 35 + h, 100, 100), "2"))
				{
					input = input + "2";
				}

				if (GUI.Button(new Rect(215, 35 + h, 100, 100), "3"))
				{
					input = input + "3";
				}

				if (GUI.Button(new Rect(5, 140 + h, 100, 100), "4"))
				{
					input = input + "4";
				}

				if (GUI.Button(new Rect(110, 140 + h, 100, 100), "5"))
				{
					input = input + "5";
				}

				if (GUI.Button(new Rect(215, 140 + h, 100, 100), "6"))
				{
					input = input + "6";
				}

				if (GUI.Button(new Rect(5, 245 + h, 100, 100), "7"))
				{
					input = input + "7";
				}

				if (GUI.Button(new Rect(110, 245 + h, 100, 100), "8"))
				{
					input = input + "8";
				}

				if (GUI.Button(new Rect(215, 245 + h, 100, 100), "9"))
				{
					input = input + "9";
				}

				if (GUI.Button(new Rect(110, 350 + h, 100, 100), "0"))
				{
					input = input + "0";
				}
				...
				if (GUI.Button(new Rect(5, 350 + h, 100, 100), "DEL"))
				{
					input = null;
				}
			}
